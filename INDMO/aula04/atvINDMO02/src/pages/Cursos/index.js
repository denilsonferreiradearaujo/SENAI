    ...
    return (
        <SafeAreaView style={styles.styleCursos}>
            ...
            <View style={styles.Caixa}>
                ...
                <Text style={styles.Description}>Focado em programas de linguagem WEB e Mobile. Trabalha alguns tipo de linguagem SQL e montagem de banco de dados em geral, também trabalha-se com repositórios em Núvem  como o GitHub.</Text>
            </View>
            <View style={styles.Caixa}>
